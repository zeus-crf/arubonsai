...
$sql = "SELECT * FROM produtos WHERE categoria = 'Bebida Alcoólica' ";
...
<body>
    ...
    <span class="text-white font-medium">Rua dev 10,Santa Cruz da Serra</span>
    ...
    <div >
        ...
        <button name="cat-bebidas" value="<?php echo 'Bebidas' ?>"class="bg-zinc-900 text-primary-foreground py-2 px-4 rounded-lg w-32 text-white shadow-md transition duration-300 hover:bg-primary/80 focus:outline-none focus:ring-2 focus:ring-ring hover:bg-green-600/65 valid:" ><li><a href="http://localhost/Projeto/indexbebidas.php">Bedidas</a></li></button>
        </form>
    </div> 
    <span class="opacity-50">|</span>
    
    <button class="hover:text-green-600"><a href="http://localhost/Projeto/index.php">Inicio</a></button>
    <span class="opacity-50">|</span>
...
<!--Inicio Menu-->
        ...
        <div class ="mx-auto max-w-7xl px-2 my-2">
            <h2 class="font-bold text-2xl">Drinks Clássicos</h2>
        </div>
...
<div class ="mx-auto max-w-7xl px-2 my-2">
            <h2 class="font-bold text-2xl">Cervejas</h2>
        </div>
...
<div class ="mx-auto max-w-7xl px-2 my-2">
            <h2 class="font-bold text-2xl">Bebidas</h2>
        </div>
...
<!--BUTTON CART FOOTER-->
<footer class="w-full bg-green-800 py-3 fixed bottom-0 z-40 flex items-center justify-center">
