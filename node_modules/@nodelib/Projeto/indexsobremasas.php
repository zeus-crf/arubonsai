...
$sql = "SELECT * FROM produtos WHERE categoria = 'Sobremesa' ";
...
<body>
    ...
    <div >
        <button class="bg-zinc-900 text-primary-foreground py-2 px-4 rounded-lg w-32 text-white shadow-md transition duration-300 hover:bg-primary/80 focus:outline-none focus:ring-2 focus:ring-ring hover:bg-green-600/65 valid:" >Sobremesas</button>
    </div> 
    </ul>
...
<!--Inicio Menu-->
        ...
        <div class ="mx-auto max-w-7xl px-2 my-2">
            <h2 class="font-bold text-2xl">Sobremesas</h2>
        </div>
